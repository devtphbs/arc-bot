...
Deno.serve(async (req: any) => {
  ...
  try {
    ...
    const reqBody = await req.json() as { bot_id?: string; action?: string; name?: string; avatar?: string; status_text?: string; activity_type?: number; presence_status?: string; guild_id?: string };
