...
const features = [
  { icon: Terminal, title: "Visual Command Builder", desc: "Create slash, prefix, and context menu commands without writing code" },
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 lg:px-12 h-16 border-b border-border">
        ...
        <button
          ...
          className="px-4 py-2 rounded-md bg-gradient-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity glow-primary"
        >
          Open Dashboard
        </button>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mt-8">
            <button
              onClick={() => navigate("/dashboard")}
              className="flex items-center gap-2 px-6 py-3 rounded-md bg-gradient-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity glow-primary"
            >
        ...
        <motion.div
          ...
          className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 max-w-4xl w-full"
        >
          {features.map((f, i) => (
