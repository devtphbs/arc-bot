          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="rounded-lg border border-border bg-card p-5">
            ...
            <div className="flex flex-col items-center py-4">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                <div className={cn("w-2 h-2 rounded-full", isOnline ? "bg-green-500" : "bg-muted-foreground")} />
                <p className={cn("text-xs capitalize", isOnline ? "text-green-500" : "text-muted-foreground")}>{botAction || selectedBot.status}</p>
              </div>
              ...
              {recentLogs.map((log) => (
                <div key={log.id} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                  <div className="flex items-center gap-3">
                    <div className={cn("w-1.5 h-1.5 rounded-full", log.level === "error" ? "bg-destructive" : log.level === "warn" ? "bg-yellow-500" : "bg-primary")} />
